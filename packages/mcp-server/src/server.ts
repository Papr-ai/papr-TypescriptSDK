...
export { ClientOptions } from '@papr/memory';
...
async function getInstructions() {
  ...
  const response = await fetch(
    readEnv('CODE_MODE_INSTRUCTIONS_URL') ?? 'https://api.stainless.com/api/ai/instructions/papr-memory',
    {
      method: 'GET',
  ...
  if (!response.ok) {
    ...
    instructions = `
      This is the papr-memory MCP server. You will use Code Mode to help the user perform
