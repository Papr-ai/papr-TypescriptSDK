...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: [
      'candidates: { id: string; content?: string; context_metadata?: object; embedding?: number[]; metadata_embeddings?: object; phases?: number[]; score?: number; }[];',
      'query: string;',
      'domain?: string;',
      'frequency_schema_id?: string;',
