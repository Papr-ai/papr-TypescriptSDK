...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: [
      ...
      "policy?: { acl?: { read?: string[]; write?: string[]; }; consent?: 'explicit' | 'implicit' | 'terms' | 'none'; graph?: { edge_constraints?: { create?: 'upsert' | 'lookup' | 'auto' | 'never'; direction?: 'outgoing' | 'incoming' | 'both'; edge_type?: string; link_only?: boolean; on_miss?: 'create' | 'ignore' | 'error'; search?: search_config_input; set?: object; source_type?: string; target_type?: string; when?: object; }[]; link_to?: string | string[] | object; mode?: 'none' | 'auto' | 'manual'; node_constraints?: { create?: 'upsert' | 'lookup' | 'auto' | 'never'; link_only?: boolean; node_type?: string; on_miss?: 'create' | 'ignore' | 'error'; search?: search_config_input; set?: object; when?: object; }[]; nodes?: { id: string; type: string; properties?: object; }[]; relationships?: { source: string; target: string; type: string; properties?: object; }[]; schema_id?: string; }; risk?: 'none' | 'sensitive' | 'flagged'; transform_embedding?: { domain_id?: string; mode?: 'none' | 'auto' | 'manual'; signals?: object; }; };",
  ...
  },
  {
    ...
    params: [
      ...
      'organization_id?: string;',
      "policy?: { acl?: { read?: string[]; write?: string[]; }; consent?: 'explicit' | 'implicit' | 'terms' | 'none'; graph?: { edge_constraints?: { create?: 'upsert' | 'lookup' | 'auto' | 'never'; direction?: 'outgoing' | 'incoming' | 'both'; edge_type?: string; link_only?: boolean; on_miss?: 'create' | 'ignore' | 'error'; search?: search_config_input; set?: object; source_type?: string; target_type?: string; when?: object; }[]; link_to?: string | string[] | object; mode?: 'none' | 'auto' | 'manual'; node_constraints?: { create?: 'upsert' | 'lookup' | 'auto' | 'never'; link_only?: boolean; node_type?: string; on_miss?: 'create' | 'ignore' | 'error'; search?: search_config_input; set?: object; when?: object; }[]; nodes?: { id: string; type: string; properties?: object; }[]; relationships?: { source: string; target: string; type: string; properties?: object; }[]; schema_id?: string; }; rerank?: { enabled?: boolean; model?: string; provider?: string; }; risk?: 'none' | 'sensitive' | 'flagged'; vector?: { domain_id?: string; mode?: 'fast' | 'enhanced' | 'max'; return_debug?: boolean; return_signal_scores?: boolean; signal_multipliers?: object; signal_thresholds?: object; }; };",
