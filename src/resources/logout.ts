...
export class Logout extends APIResource {
   ...
   */
  perform(options?: RequestOptions): APIPromise<LogoutPerformResponse> {
 ...
 */
export interface LogoutPerformResponse {
  /**
...
export declare namespace Logout {
  export { type LogoutPerformResponse as LogoutPerformResponse };
}
