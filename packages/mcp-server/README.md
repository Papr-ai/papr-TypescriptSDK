...
```
claude mcp add papr_memory_mcp_api --env PAPR_MEMORY_API_KEY="My X API Key" PAPR_MEMORY_Session_Token="My X Session Token" PAPR_MEMORY_BEARER_TOKEN="My Bearer Token" -- npx -y @papr/memory-mcp
```
