...
export const sdkMethods: SdkMethod[] = [
  ...
  {
    clientCallName: 'client.namespace.instance.delete',
    fullyQualifiedName: 'namespace.instance.delete',
    httpMethod: 'delete',
    httpPath: '/v1/namespace/{namespace_id}/instance',
  },
  {
  ...
  {
    clientCallName: 'client.organization.instance.delete',
    fullyQualifiedName: 'organization.instance.delete',
    httpMethod: 'delete',
    httpPath: '/v1/organization/instance',
  },
  {
    clientCallName: 'client.ai.getUsage',
    fullyQualifiedName: 'ai.getUsage',
    httpMethod: 'get',
  ...
  },
  {
    ...
    httpMethod: 'post',
    httpPath: '/v1/ai/openai/responses',
  },
  {
    clientCallName: 'client.ai.openai.chat.createCompletion',
    fullyQualifiedName: 'ai.openai.chat.createCompletion',
    httpMethod: 'post',
    httpPath: '/v1/ai/openai/chat/completions',
  },
  {
    clientCallName: 'client.ai.anthropic.sendMessage',
    fullyQualifiedName: 'ai.anthropic.sendMessage',
    httpMethod: 'post',
    httpPath: '/v1/ai/anthropic/messages',
  },
  {
    clientCallName: 'client.ai.google.models.generateContent',
    fullyQualifiedName: 'ai.google.models.generateContent',
    httpMethod: 'post',
    httpPath: '/v1/ai/google/models/{model_id}:generateContent',
  },
  {
    clientCallName: 'client.ai.google.models.streamGenerateContent',
    fullyQualifiedName: 'ai.google.models.streamGenerateContent',
    httpMethod: 'post',
    httpPath: '/v1/ai/google/models/{model_id}:streamGenerateContent',
  },
  {
    clientCallName: 'client.telemetry.trackEvent',
    fullyQualifiedName: 'telemetry.trackEvent',
    httpMethod: 'post',
