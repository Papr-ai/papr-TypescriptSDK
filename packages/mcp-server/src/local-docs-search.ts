...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: [
      ...
      "policy?: { acl?: { read?: string[]; write?: string[]; }; consent?: 'explicit' | 'implicit' | 'terms' | 'none'; graph?: { edge_constraints?: edge_constraint_input[]; link_to?: string | string[] | object; mode?: 'none' | 'auto' | 'manual'; node_constraints?: node_constraint_input[]; nodes?: node_spec[]; relationships?: relationship_spec[]; schema_id?: string; }; risk?: 'none' | 'sensitive' | 'flagged'; transform_embedding?: { domain_id?: string; mode?: 'none' | 'auto' | 'manual'; signals?: object; }; };",
  ...
  },
  {
    ...
    params: [
      ...
      'external_user_id?: string;',
      "holographic_config?: { enabled?: boolean; frequency_filters?: object; frequency_schema_id?: string; hcond_boost_factor?: number; hcond_boost_threshold?: number; hcond_penalty_factor?: number; include_frequency_scores?: boolean; scoring_method?: string; search_mode?: 'disabled' | 'integrated' | 'post_search'; };",
      "metadata?: { acl?: object; assistantMessage?: string; category?: 'preference' | 'task' | 'goal' | 'fact' | 'context' | 'skills' | 'learning'; consent?: string; conversationId?: string; createdAt?: string; customMetadata?: object; emoji tags?: string[]; emotion tags?: string[]; external_user_id?: string; external_user_read_access?: string[]; external_user_write_access?: string[]; goalClassificationScores?: number[]; hierarchical_structures?: string | object[]; location?: string; namespace_id?: string; namespace_read_access?: string[]; namespace_write_access?: string[]; organization_id?: string; organization_read_access?: string[]; organization_write_access?: string[]; pageId?: string; post?: string; relatedGoals?: string[]; relatedSteps?: string[]; relatedUseCases?: string[]; risk?: string; role?: 'user' | 'assistant'; role_read_access?: string[]; role_write_access?: string[]; sessionId?: string; sourceType?: string; sourceUrl?: string; stepClassificationScores?: number[]; topics?: string[]; upload_id?: string; useCaseClassificationScores?: number[]; user_id?: string; user_read_access?: string[]; user_write_access?: string[]; userMessage?: string; workspace_id?: string; workspace_read_access?: string[]; workspace_write_access?: string[]; };",
      'namespace_id?: string;',
      ...
      'organization_id?: string;',
      "policy?: { acl?: { read?: string[]; write?: string[]; }; consent?: 'explicit' | 'implicit' | 'terms' | 'none'; graph?: { edge_constraints?: object[]; link_to?: string | string[] | object; mode?: 'none' | 'auto' | 'manual'; node_constraints?: object[]; nodes?: object[]; relationships?: object[]; schema_id?: string; }; rerank?: { enabled?: boolean; model?: string; provider?: string; }; risk?: 'none' | 'sensitive' | 'flagged'; vector?: { domain_id?: string; mode?: 'fast' | 'enhanced' | 'max'; return_debug?: boolean; return_signal_scores?: boolean; signal_multipliers?: object; signal_thresholds?: object; }; };",
  ...
  },
  {
    ...
    response:
      '{ code?: number; data?: { createdAt?: string; default_policy?: object; environment_type?: string; instance_config?: instance_config_item; is_active?: boolean; memoriesCount?: number; name?: string; objectId?: string; organization_id?: string; rate_limits?: object; storageCount?: number; updatedAt?: string; }; details?: object; error?: string; status?: string; }',
    markdown:
      "## update\n\n`client.namespace.update(namespace_id: string, default_policy?: object, environment_type?: 'development' | 'staging' | 'production', is_active?: boolean, name?: string, rate_limits?: object): { code?: number; data?: namespace_item; details?: object; error?: string; status?: string; }`\n\n**put** `/v1/namespace/{namespace_id}`\n\nUpdate an existing namespace.\n\n### Parameters\n\n- `namespace_id: string`\n\n- `default_policy?: object`\n  Default memory policy for add/search when request omits policy.\n\n- `environment_type?: 'development' | 'staging' | 'production'`\n  Environment types for namespaces\n\n- `is_active?: boolean`\n  Whether this namespace is active\n\n- `name?: string`\n  Updated namespace name\n\n- `rate_limits?: object`\n  Updated rate limits (None values inherit from organization)\n\n### Returns\n\n- `{ code?: number; data?: { createdAt?: string; default_policy?: object; environment_type?: string; instance_config?: instance_config_item; is_active?: boolean; memoriesCount?: number; name?: string; objectId?: string; organization_id?: string; rate_limits?: object; storageCount?: number; updatedAt?: string; }; details?: object; error?: string; status?: string; }`\n  Response for single-namespace operations (create, get, update).\n\n  - `code?: number`\n  - `data?: { createdAt?: string; default_policy?: object; environment_type?: string; instance_config?: { provider: string; region: string; scope: string; neo4j?: neo4j_instance_config_item; }; is_active?: boolean; memoriesCount?: number; name?: string; objectId?: string; organization_id?: string; rate_limits?: object; storageCount?: number; updatedAt?: string; }`\n  - `details?: object`\n  - `error?: string`\n  - `status?: string`\n\n### Example\n\n```typescript\nimport Papr from '@papr/memory';\n\nconst client = new Papr();\n\nconst namespace = await client.namespace.update('namespace_id');\n\nconsole.log(namespace);\n```",
    perLanguage: {
      typescript: {
  ...
  {
    name: 'create_api_key',
    endpoint: '/v1/namespace/{namespace_id}/api-keys',
    httpMethod: 'post',
    ...
    stainlessPath: '(resource) namespace > (method) create_api_key',
    qualified: 'client.namespace.createAPIKey',
    params: [
      'namespace_id: string;',
      'name: string;',
    ...
    response:
      '{ code?: number; data?: { createdAt?: string; environment?: string; is_active?: boolean; key?: string; key_prefix?: string; name?: string; namespace_id?: string; objectId?: string; organization_id?: string; permissions?: string[]; }; details?: object; error?: string; status?: string; }',
    markdown:
      "## create_api_key\n\n`client.namespace.createAPIKey(namespace_id: string, name: string, environment?: 'development' | 'staging' | 'production', permissions?: 'read' | 'write' | 'delete'[]): { code?: number; data?: object; details?: object; error?: string; status?: string; }`\n\n**post** `/v1/namespace/{namespace_id}/api-keys`\n\nMint a new API key bound to the given namespace. Caller must authenticate with any API key belonging to the same organization (typically the org-wide / default-namespace key).\n\n**Security:** The full key is returned exactly once in this response. Store it immediately — it cannot be retrieved later. Subsequent reads expose only the masked `key_prefix`.\n\n### Parameters\n\n- `namespace_id: string`\n\n- `name: string`\n  Human-readable name for the API key (shown in admin UIs).\n\n- `environment?: 'development' | 'staging' | 'production'`\n  Environment label: development, staging, or production.\n\n- `permissions?: 'read' | 'write' | 'delete'[]`\n  Permissions granted by this key. Must be a subset of ['read', 'write', 'delete'].\n\n### Returns\n\n- `{ code?: number; data?: { createdAt?: string; environment?: string; is_active?: boolean; key?: string; key_prefix?: string; name?: string; namespace_id?: string; objectId?: string; organization_id?: string; permissions?: string[]; }; details?: object; error?: string; status?: string; }`\n  Response for ``POST /v1/namespace/{namespace_id}/api-keys``.\n\n  - `code?: number`\n  - `data?: { createdAt?: string; environment?: string; is_active?: boolean; key?: string; key_prefix?: string; name?: string; namespace_id?: string; objectId?: string; organization_id?: string; permissions?: string[]; }`\n  - `details?: object`\n  - `error?: string`\n  - `status?: string`\n\n### Example\n\n```typescript\nimport Papr from '@papr/memory';\n\nconst client = new Papr();\n\nconst response = await client.namespace.createAPIKey('namespace_id', { name: 'Acme Production API Key' });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
        method: 'client.namespace.createAPIKey',
        example:
  ...
  },
  {
    ...
    httpMethod: 'post',
    summary: '[DEPRECATED] Rerank search results using holographic scoring — use /v1/graph/rerank',
    description:
    ...
    params: [
      'candidates: { id: string; concat_embedding?: number[]; content?: string; context_metadata?: object; embedding?: number[]; metadata_embeddings?: object; phases?: number[]; rotation_embedding?: number[]; rotation_v2_embedding?: number[]; rotation_v3_embedding?: number[]; score?: number; }[];',
      'query: string;',
      'domain?: string;',
      'frequency_schema_id?: string;',
      "options?: { cross_encoder_model?: string; cross_encoder_weight?: number; ensemble?: 'auto' | 'caesar_8' | 'caesar_9'; frequency_filters?: object; include_frequency_scores?: boolean; return_scores?: boolean; scoring_method?: string; use_cross_encoder?: boolean; };",
      'query_dimension_weights?: object;',
      'query_embedding?: number[];',
      'query_metadata_embeddings?: object;',
      'query_phases?: number[];',
      'top_k?: number;',
    ],
    response:
      '{ data: { domain: string; ensemble_used: string; rankings: { id: string; path: string; rank: number; score: number; frequency_scores?: object; original_score?: number; scores?: object; }[]; timing_ms: number; optimization_hint?: string; query_dimension_weights?: object; }; status?: string; }',
    markdown:
      "## rerank\n\n`client.holographic.rerank(candidates: { id: string; concat_embedding?: number[]; content?: string; context_metadata?: object; embedding?: number[]; metadata_embeddings?: object; phases?: number[]; rotation_embedding?: number[]; rotation_v2_embedding?: number[]; rotation_v3_embedding?: number[]; score?: number; }[], query: string, domain?: string, frequency_schema_id?: string, options?: { cross_encoder_model?: string; cross_encoder_weight?: number; ensemble?: 'auto' | 'caesar_8' | 'caesar_9'; frequency_filters?: object; include_frequency_scores?: boolean; return_scores?: boolean; scoring_method?: string; use_cross_encoder?: boolean; }, query_dimension_weights?: object, query_embedding?: number[], query_metadata_embeddings?: object, query_phases?: number[], top_k?: number): { data: object; status?: string; }`\n\n**post** `/v1/holographic/rerank`\n\nThe simplest entry point — zero infrastructure needed. Send your search query and candidate results, get back better-ranked results using CAESAR ensemble. \n\n**Auto-detection:** candidates with `phases` use the fast path (~2-5ms each). Candidates with only `content` use the cold path (~100ms each, includes LLM extraction). You can mix both in a single request.\n\n### Parameters\n\n- `candidates: { id: string; concat_embedding?: number[]; content?: string; context_metadata?: object; embedding?: number[]; metadata_embeddings?: object; phases?: number[]; rotation_embedding?: number[]; rotation_v2_embedding?: number[]; rotation_v3_embedding?: number[]; score?: number; }[]`\n  Candidate documents to rerank (max 100)\n\n- `query: string`\n  The search query text\n\n- `domain?: string`\n  Domain for frequency schema\n\n- `frequency_schema_id?: string`\n  Schema override\n\n- `options?: { cross_encoder_model?: string; cross_encoder_weight?: number; ensemble?: 'auto' | 'caesar_8' | 'caesar_9'; frequency_filters?: object; include_frequency_scores?: boolean; return_scores?: boolean; scoring_method?: string; use_cross_encoder?: boolean; }`\n  Options for the rerank endpoint.\n  - `cross_encoder_model?: string`\n    Cross-encoder model name. Options: 'BAAI/bge-reranker-v2-m3' (fast, default), 'Qwen/Qwen3-Reranker-0.6B' (balanced), 'Qwen/Qwen3-Reranker-4B' (best quality).\n  - `cross_encoder_weight?: number`\n    Weight for cross-encoder score in final blend. final = (1 - weight) * hcond + weight * cross_encoder. Default 0.3.\n  - `ensemble?: 'auto' | 'caesar_8' | 'caesar_9'`\n    Ensemble method: 'auto' (recommended), 'caesar_8', or 'caesar_9'\n  - `frequency_filters?: object`\n    Filter candidates by minimum per-frequency-field score. Keys are field names (e.g. 'date', 'entity'), values are min scores [0, 1].\n  - `include_frequency_scores?: boolean`\n    Include per-frequency-field alignment scores (e.g. date: 0.92, entity: 0.45). Requires return_scores=true to take effect.\n  - `return_scores?: boolean`\n    Include per-method score breakdown in response\n  - `scoring_method?: string`\n    Specific scoring method from 160+ available (power user). Overrides ensemble.\n  - `use_cross_encoder?: boolean`\n    Enable cross-encoder scoring. Requires content on candidates. Adds ~20-50ms per candidate but improves ranking quality by 3-8%%.\n\n- `query_dimension_weights?: object`\n  Pre-computed per-field weights from a prior /transform call (is_query=true). If provided, skips the adaptive Groq weights call entirely (saves ~500ms + LLM cost). Keyed by frequency string (e.g. '0.1') OR field name (e.g. 'mega_domain').\n\n- `query_embedding?: number[]`\n  Query embedding in the same space as candidate embeddings. If provided, used for cosine similarity. If omitted, computed server-side (Qwen 2560d).\n\n- `query_metadata_embeddings?: object`\n  Pre-computed query metadata embeddings from a prior /transform call (keyed by frequency string, e.g. '0.1'). Required for full HCond scoring with phase alignment.\n\n- `query_phases?: number[]`\n  Pre-computed query phases from a prior /transform call. If provided alongside query_embedding, skips LLM extraction entirely (hot path).\n\n- `top_k?: number`\n  Number of results to return\n\n### Returns\n\n- `{ data: { domain: string; ensemble_used: string; rankings: { id: string; path: string; rank: number; score: number; frequency_scores?: object; original_score?: number; scores?: object; }[]; timing_ms: number; optimization_hint?: string; query_dimension_weights?: object; }; status?: string; }`\n  Response for POST /v1/holographic/rerank\n\n  - `data: { domain: string; ensemble_used: string; rankings: { id: string; path: string; rank: number; score: number; frequency_scores?: object; original_score?: number; scores?: object; }[]; timing_ms: number; optimization_hint?: string; query_dimension_weights?: object; }`\n  - `status?: string`\n\n### Example\n\n```typescript\nimport Papr from '@papr/memory';\n\nconst client = new Papr();\n\nconst response = await client.holographic.rerank({ candidates: [{ id: 'doc_1' }, { id: 'doc_2' }], query: 'How does troponin relate to myocardial infarction?' });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    httpMethod: 'post',
    summary: '[DEPRECATED] Extract metadata only (for on-device transform) — use /v1/graph/metadata',
    description:
  ...
  },
  {
    ...
    httpMethod: 'post',
    summary: '[DEPRECATED] Transform text + embedding into holographic embeddings — use /v1/graph/transform',
    description:
    ...
    response:
      '{ data: { base_dim: number; domain: string; frequency_schema_id: string; timing_ms: number; base?: number[]; concat?: number[]; dimension_weights?: object; metadata?: object; metadata_embeddings?: object; phases?: number[]; rotation_v1?: number[]; rotation_v2?: number[]; rotation_v3?: number[]; }; status?: string; }',
    markdown:
      "## create\n\n`client.holographic.transform.create(content: string, embedding: number[], concat_embedding?: number[], context_metadata?: object, domain?: string, frequency_schema_id?: string, is_query?: boolean, output?: string[], rotation_embedding?: number[], rotation_v2_embedding?: number[], rotation_v3_embedding?: number[]): { data: transform_data; status?: string; }`\n\n**post** `/v1/holographic/transform`\n\nCore BYOE endpoint. Send text content and your base embedding (any dimensions) to get back holographic-transformed embeddings. Use `output` to control which fields are returned. Default: rotation_v3 + metadata.\n\n### Parameters\n\n- `content: string`\n  Text content for LLM metadata extraction\n\n- `embedding: number[]`\n  Base embedding vector (any dimensionality)\n\n- `concat_embedding?: number[]`\n  Pre-computed concat (new) embedding from holographic transform.\n\n- `context_metadata?: object`\n  Optional context metadata (createdAt, sourceType, customMetadata, etc.) to improve LLM extraction accuracy, especially for dates and entities.\n\n- `domain?: string`\n  Domain for frequency schema selection (e.g. 'biomedical', 'code', 'general')\n\n- `frequency_schema_id?: string`\n  Specific frequency schema ID override (e.g. 'biomedical:scifact:2.0.0'). Takes precedence over domain.\n\n- `is_query?: boolean`\n  If true, treat content as a query (not a doc): runs adaptive dimension-weight scoring and returns weights in TransformData. Pass these weights into a subsequent /rerank call as `query_dimension_weights` to skip recomputation.\n\n- `output?: string[]`\n  Which output fields to return. Default: ['rotation_v3', 'metadata']. Request only what you need to minimize response size.\n\n- `rotation_embedding?: number[]`\n  Pre-computed rotation (old) embedding from holographic transform. Enables rot_v2/v3 similarity scoring and full CAESAR ensemble.\n\n- `rotation_v2_embedding?: number[]`\n  Pre-computed rotation V2 embedding from holographic transform.\n\n- `rotation_v3_embedding?: number[]`\n  Pre-computed rotation V3 embedding from holographic transform.\n\n### Returns\n\n- `{ data: { base_dim: number; domain: string; frequency_schema_id: string; timing_ms: number; base?: number[]; concat?: number[]; dimension_weights?: object; metadata?: object; metadata_embeddings?: object; phases?: number[]; rotation_v1?: number[]; rotation_v2?: number[]; rotation_v3?: number[]; }; status?: string; }`\n  Response for POST /v1/holographic/transform\n\n  - `data: { base_dim: number; domain: string; frequency_schema_id: string; timing_ms: number; base?: number[]; concat?: number[]; dimension_weights?: object; metadata?: object; metadata_embeddings?: object; phases?: number[]; rotation_v1?: number[]; rotation_v2?: number[]; rotation_v3?: number[]; }`\n  - `status?: string`\n\n### Example\n\n```typescript\nimport Papr from '@papr/memory';\n\nconst client = new Papr();\n\nconst transform = await client.holographic.transform.create({ content: 'The patient presents with elevated troponin levels indicating myocardial damage', embedding: [0.1, -0.2, 0.3] });\n\nconsole.log(transform);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    httpMethod: 'post',
    summary: '[DEPRECATED] Batch transform multiple items — use /v1/graph/transform/batch',
    ...
    params: [
      'items: { id: string; content: string; embedding: number[]; concat_embedding?: number[]; context_metadata?: object; rotation_embedding?: number[]; rotation_v2_embedding?: number[]; rotation_v3_embedding?: number[]; }[];',
      'domain?: string;',
      'frequency_schema_id?: string;',
      'output?: string[];',
    ],
    ...
    markdown:
      "## create_batch\n\n`client.holographic.transform.createBatch(items: { id: string; content: string; embedding: number[]; concat_embedding?: number[]; context_metadata?: object; rotation_embedding?: number[]; rotation_v2_embedding?: number[]; rotation_v3_embedding?: number[]; }[], domain?: string, frequency_schema_id?: string, output?: string[]): { results: object[]; timing_ms: number; total: number; status?: string; }`\n\n**post** `/v1/holographic/transform/batch`\n\nTransform up to 50 items in a single request. Same as /transform but batched.\n\n### Parameters\n\n- `items: { id: string; content: string; embedding: number[]; concat_embedding?: number[]; context_metadata?: object; rotation_embedding?: number[]; rotation_v2_embedding?: number[]; rotation_v3_embedding?: number[]; }[]`\n  Items to transform (max 50)\n\n- `domain?: string`\n  Domain for all items\n\n- `frequency_schema_id?: string`\n  Schema override for all items\n\n- `output?: string[]`\n  Which output fields to return for each item\n\n### Returns\n\n- `{ results: { id: string; data: object; }[]; timing_ms: number; total: number; status?: string; }`\n  Response for POST /v1/holographic/transform/batch\n\n  - `results: { id: string; data: { base_dim: number; domain: string; frequency_schema_id: string; timing_ms: number; base?: number[]; concat?: number[]; dimension_weights?: object; metadata?: object; metadata_embeddings?: object; phases?: number[]; rotation_v1?: number[]; rotation_v2?: number[]; rotation_v3?: number[]; }; }[]`\n  - `timing_ms: number`\n  - `total: number`\n  - `status?: string`\n\n### Example\n\n```typescript\nimport Papr from '@papr/memory';\n\nconst client = new Papr();\n\nconst response = await client.holographic.transform.createBatch({ items: [{\n  id: 'id',\n  content: 'content',\n  embedding: [0],\n}] });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    httpMethod: 'get',
    summary: '[DEPRECATED] List available holographic domains — use /v1/graph/domains',
    description:
  ...
  },
  {
    ...
    endpoint: '/v1/holographic/domains',
    httpMethod: 'post',
    summary: '[DEPRECATED] Create a custom frequency schema — use /v1/graph/domains',
    description:
  ...
  },
  {
    ...
    httpMethod: 'post',
    summary: 'Producer endpoint -- text -> phases + signals + embeddings',
    description:
    ...
    stainlessPath: '(resource) graph > (method) transform',
    qualified: 'client.graph.transform',
    params: [
      'text: string;',
      'domain_id?: string;',
      'embedding?: number[];',
  ...
  {
    name: 'rerank',
    endpoint: '/v1/graph/rerank',
    httpMethod: 'post',
    summary: 'Rerank candidate documents against a query',
    description: 'Rerank candidate documents against a query',
    stainlessPath: '(resource) graph > (method) rerank',
    qualified: 'client.graph.rerank',
    params: [
      'documents: string | { id?: string; concat_embedding?: number[]; embedding?: number[]; metadata?: object; phases?: number[]; rot_v3?: number[]; signal_embeddings?: object; signals?: object; text?: string; }[];',
      'query: string | { text: string; concat_embedding?: number[]; embedding?: number[]; phases?: number[]; rot_v3?: number[]; signal_embeddings?: object; signals?: object; };',
      'domain_id?: string;',
      "method?: 'fast' | 'enhanced';",
      'return_debug?: boolean;',
      'return_documents?: boolean;',
      'return_signal_scores?: boolean;',
      'routing_config?: { caesar4_source?: string; ce_gate_min_phi?: number; disabled_rules?: string[]; egr_lambda_ce?: number; enabled_rule_packs?: string[]; enhanced_initial_source?: string; holographic_floor?: boolean; threshold_overrides?: object; };',
      "signal_embedder?: 'sbert' | 'qwen';",
      'signal_filters?: object;',
      'signal_multipliers?: object;',
      'top_k?: number;',
    ],
    response:
      "{ id: string; meta: { domain_id: string; method_used: 'enhanced' | 'max' | 'fast'; billed_units?: number; debug?: object; timing_ms?: object; usage?: object; }; results: { index: number; relevance_score: number; id?: string; debug_scores?: object; document?: object; score_method?: string; signal_scores?: object; signal_scores_by_band?: object; }[]; }",
    markdown:
      "## rerank\n\n`client.graph.rerank(documents: string | { id?: string; concat_embedding?: number[]; embedding?: number[]; metadata?: object; phases?: number[]; rot_v3?: number[]; signal_embeddings?: object; signals?: object; text?: string; }[], query: string | { text: string; concat_embedding?: number[]; embedding?: number[]; phases?: number[]; rot_v3?: number[]; signal_embeddings?: object; signals?: object; }, domain_id?: string, method?: 'fast' | 'enhanced', return_debug?: boolean, return_documents?: boolean, return_signal_scores?: boolean, routing_config?: { caesar4_source?: string; ce_gate_min_phi?: number; disabled_rules?: string[]; egr_lambda_ce?: number; enabled_rule_packs?: string[]; enhanced_initial_source?: string; holographic_floor?: boolean; threshold_overrides?: object; }, signal_embedder?: 'sbert' | 'qwen', signal_filters?: object, signal_multipliers?: object, top_k?: number): { id: string; meta: object; results: object[]; }`\n\n**post** `/v1/graph/rerank`\n\nRerank candidate documents against a query\n\n### Parameters\n\n- `documents: string | { id?: string; concat_embedding?: number[]; embedding?: number[]; metadata?: object; phases?: number[]; rot_v3?: number[]; signal_embeddings?: object; signals?: object; text?: string; }[]`\n  Candidate documents (string or DocumentInput with pre-computed artifacts).\n\n- `query: string | { text: string; concat_embedding?: number[]; embedding?: number[]; phases?: number[]; rot_v3?: number[]; signal_embeddings?: object; signals?: object; }`\n  Query text (string) or QueryItem with pre-computed artifacts.\n\n- `domain_id?: string`\n  Domain shortname or full schema id controlling which frequency bands and extraction rules are used. Built-in shortnames: \"general\" (default), \"code\", \"cosqa\", \"codetrans\", \"codetransocean\", \"codetransocean_hybrid\", \"text2sql\", \"scifact\", \"nfcorpus\", \"fiqa\", \"legal\", \"medical\", \"ecommerce\", \"coffee_shops\". You can also pass a full schema id (e.g. \"code_search:cosqa:2.0.0\") or a custom domain_id registered via POST /v1/graph/domains.\n\n- `method?: 'fast' | 'enhanced'`\n  Public: enhanced or max (CE reranker). Accepts deprecated 'fast'/'enhanced' aliases.\n\n- `return_debug?: boolean`\n  If true, include CAESAR meta-signals + timing in `meta.debug`.\n\n- `return_documents?: boolean`\n  If true, echo back each input document in the result.\n\n- `return_signal_scores?: boolean`\n  If true, each result carries `signal_scores` (method-level scores like `base_sim`, `caesar8_score`) and `signal_scores_by_band` (per-frequency band alignments such as `key_apis`, `language`).\n\n- `routing_config?: { caesar4_source?: string; ce_gate_min_phi?: number; disabled_rules?: string[]; egr_lambda_ce?: number; enabled_rule_packs?: string[]; enhanced_initial_source?: string; holographic_floor?: boolean; threshold_overrides?: object; }`\n  Domain-scoped CAESAR-VIII routing overrides (stored on graph_domains).\n  - `caesar4_source?: string`\n    Which ranking is exposed as rankings['caesar4'] to CAESAR-VIII rules (c4_c7_diverge, etc.). Accepts 'v4a' (default — alias to family-routed v4a / v3a fallback), 'v3a' (force v3a only), or 'legacy' (SKIP the alias; keep the original Jaccard / trust-score selection at rankings['caesar4'] and stash a copy at rankings['_caesar4_legacy']). Use 'legacy' to A/B C-VIII rules against the original SciFact calibration semantics. Label-free in all modes.\n  - `ce_gate_min_phi?: number`\n    Minimum phi to allow caesar7/baseline_rerank to bypass holographic floor.\n  - `disabled_rules?: string[]`\n    Global SciFact routing rule names to skip for this domain (e.g. 'DANGER_LOW_RSG_LOW_PHI').\n  - `egr_lambda_ce?: number`\n    Stacked EGR entailment fusion weight (0–1). Lower for code domains.\n  - `enabled_rule_packs?: string[]`\n    Named domain rule packs to run after global rules (e.g. 'cosqa_caesar8_v2').\n  - `enhanced_initial_source?: string`\n    CAESAR-VIII initial source for the CE-on path. Domain defaults may pin 'caesar4_5_v4a' on code_search for public enhanced; public max overrides to 'caesar7' unless this field is set.\n  - `holographic_floor?: boolean`\n    When true, never return a ranking worse than max(v4a, baseline) unless CE gate (ce_gate_min_phi) passes.\n  - `threshold_overrides?: object`\n    Optional CaesarConfig field overrides keyed by threshold name (e.g. {'cmas_c4_trust_jaccard_threshold': 0.95}).\n\n- `signal_embedder?: 'sbert' | 'qwen'`\n  Embedder for per-band signal vectors when extracting query/docs. 'sbert' (384d, default) is ~10x cheaper to store than 'qwen' (2560d). Must match the embedder used for any BYO signal_embeddings.\n\n- `signal_filters?: object`\n  Hard cutoffs on per-frequency signals, e.g. {'domain_match': 0.6}. Docs below are dropped.\n\n- `signal_multipliers?: object`\n  Per-frequency scoring weight multipliers. Keys may be field names (e.g. 'claim_stance', 'causal_verb') or Hz-strings (e.g. '19.0'). Values: 'auto' (default) or 1.0 = unchanged, 2.0 = 2x boost, 0.0 = disable that band. Fields not specified default to 'auto'. Stacks on top of the schema-level FrequencyField.weight multipliers; request-level overrides win on conflict.\n\n- `top_k?: number`\n  Return at most this many results. Defaults to len(documents).\n\n### Returns\n\n- `{ id: string; meta: { domain_id: string; method_used: 'enhanced' | 'max' | 'fast'; billed_units?: number; debug?: object; timing_ms?: object; usage?: object; }; results: { index: number; relevance_score: number; id?: string; debug_scores?: object; document?: object; score_method?: string; signal_scores?: object; signal_scores_by_band?: object; }[]; }`\n\n  - `id: string`\n  - `meta: { domain_id: string; method_used: 'enhanced' | 'max' | 'fast'; billed_units?: number; debug?: object; timing_ms?: object; usage?: object; }`\n  - `results: { index: number; relevance_score: number; id?: string; debug_scores?: object; document?: { id?: string; concat_embedding?: number[]; embedding?: number[]; metadata?: object; phases?: number[]; rot_v3?: number[]; signal_embeddings?: object; signals?: object; text?: string; }; score_method?: string; signal_scores?: object; signal_scores_by_band?: object; }[]`\n\n### Example\n\n```typescript\nimport Papr from '@papr/memory';\n\nconst client = new Papr();\n\nconst response = await client.graph.rerank({ documents: ['string'], query: 'string' });\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
        method: 'client.graph.rerank',
        example:
          "import Papr from '@papr/memory';\n\nconst client = new Papr({\n  xAPIKey: process.env['PAPR_MEMORY_API_KEY'], // This is the default and can be omitted\n});\n\nconst response = await client.graph.rerank({ documents: ['string'], query: 'string' });\n\nconsole.log(response.id);",
      },
      python: {
  ...
  {
    name: 'list',
    endpoint: '/v1/graph/domains',
    httpMethod: 'get',
    summary: "List available domains (builtins + caller's custom domains)",
    description: "List available domains (builtins + caller's custom domains)",
    stainlessPath: '(resource) graph.domains > (method) list',
    qualified: 'client.graph.domains.list',
    response:
      '{ domains: { description: string; domain_id: string; name: string; signals: object[]; builtin?: boolean; catalog?: object; catalog_buffer?: object[]; catalog_config?: object; created_at?: string; owner_namespace_id?: string; owner_organization_id?: string; owner_user_id?: string; owner_workspace_id?: string; routing_config?: object; signal_multipliers?: object; }[]; }',
    markdown:
      "## list\n\n`client.graph.domains.list(): { domains: object[]; }`\n\n**get** `/v1/graph/domains`\n\nList available domains (builtins + caller's custom domains)\n\n### Returns\n\n- `{ domains: { description: string; domain_id: string; name: string; signals: object[]; builtin?: boolean; catalog?: object; catalog_buffer?: object[]; catalog_config?: object; created_at?: string; owner_namespace_id?: string; owner_organization_id?: string; owner_user_id?: string; owner_workspace_id?: string; routing_config?: object; signal_multipliers?: object; }[]; }`\n\n  - `domains: { description: string; domain_id: string; name: string; signals: { description: string; name: string; allowed_values?: string[]; frequency_hz?: number; required?: boolean; type?: 'enum' | 'text' | 'numeric' | 'date' | 'boolean' | 'multi_value_text'; weight?: number; }[]; builtin?: boolean; catalog?: { domain_distribution?: object; entity_clusters?: object[]; last_refreshed?: string; last_updated?: string; relationship_patterns?: object[]; signal_value_counts?: object; total_documents?: number; }; catalog_buffer?: { signals: object; timestamp: string; }[]; catalog_config?: { enabled?: boolean; refresh_every_n?: number; }; created_at?: string; owner_namespace_id?: string; owner_organization_id?: string; owner_user_id?: string; owner_workspace_id?: string; routing_config?: { caesar4_source?: string; ce_gate_min_phi?: number; disabled_rules?: string[]; egr_lambda_ce?: number; enabled_rule_packs?: string[]; enhanced_initial_source?: string; holographic_floor?: boolean; threshold_overrides?: object; }; signal_multipliers?: object; }[]`\n\n### Example\n\n```typescript\nimport Papr from '@papr/memory';\n\nconst client = new Papr();\n\nconst domains = await client.graph.domains.list();\n\nconsole.log(domains);\n```",
    perLanguage: {
      typescript: {
        method: 'client.graph.domains.list',
        example:
          "import Papr from '@papr/memory';\n\nconst client = new Papr({\n  xAPIKey: process.env['PAPR_MEMORY_API_KEY'], // This is the default and can be omitted\n});\n\nconst domains = await client.graph.domains.list();\n\nconsole.log(domains.domains);",
      },
      python: {
  ...
  },
  {
    ...
    stainlessPath: '(resource) graph.domains > (method) create',
    qualified: 'client.graph.domains.create',
    params: [
      'description: string;',
      'domain_id: string;',
      'name: string;',
      "signals: { description: string; name: string; allowed_values?: string[]; frequency_hz?: number; required?: boolean; type?: 'enum' | 'text' | 'numeric' | 'date' | 'boolean' | 'multi_value_text'; weight?: number; }[];",
      'catalog_config?: { enabled?: boolean; refresh_every_n?: number; };',
      'routing_config?: { caesar4_source?: string; ce_gate_min_phi?: number; disabled_rules?: string[]; egr_lambda_ce?: number; enabled_rule_packs?: string[]; enhanced_initial_source?: string; holographic_floor?: boolean; threshold_overrides?: object; };',
      'signal_multipliers?: object;',
    ],
    response:
      "{ description: string; domain_id: string; name: string; signals: { description: string; name: string; allowed_values?: string[]; frequency_hz?: number; required?: boolean; type?: 'enum' | 'text' | 'numeric' | 'date' | 'boolean' | 'multi_value_text'; weight?: number; }[]; builtin?: boolean; catalog?: { domain_distribution?: object; entity_clusters?: catalog_entity_cluster[]; last_refreshed?: string; last_updated?: string; relationship_patterns?: catalog_relationship_pattern[]; signal_value_counts?: object; total_documents?: number; }; catalog_buffer?: { signals: object; timestamp: string; }[]; catalog_config?: { enabled?: boolean; refresh_every_n?: number; }; created_at?: string; owner_namespace_id?: string; owner_organization_id?: string; owner_user_id?: string; owner_workspace_id?: string; routing_config?: { caesar4_source?: string; ce_gate_min_phi?: number; disabled_rules?: string[]; egr_lambda_ce?: number; enabled_rule_packs?: string[]; enhanced_initial_source?: string; holographic_floor?: boolean; threshold_overrides?: object; }; signal_multipliers?: object; }",
    markdown:
      "## create\n\n`client.graph.domains.create(description: string, domain_id: string, name: string, signals: { description: string; name: string; allowed_values?: string[]; frequency_hz?: number; required?: boolean; type?: 'enum' | 'text' | 'numeric' | 'date' | 'boolean' | 'multi_value_text'; weight?: number; }[], catalog_config?: { enabled?: boolean; refresh_every_n?: number; }, routing_config?: { caesar4_source?: string; ce_gate_min_phi?: number; disabled_rules?: string[]; egr_lambda_ce?: number; enabled_rule_packs?: string[]; enhanced_initial_source?: string; holographic_floor?: boolean; threshold_overrides?: object; }, signal_multipliers?: object): { description: string; domain_id: string; name: string; signals: signal_field[]; builtin?: boolean; catalog?: domain_catalog; catalog_buffer?: catalog_buffer_entry[]; catalog_config?: domain_catalog_config; created_at?: string; owner_namespace_id?: string; owner_organization_id?: string; owner_user_id?: string; owner_workspace_id?: string; routing_config?: graph_domain_routing_config; signal_multipliers?: object; }`\n\n**post** `/v1/graph/domains`\n\nCreate a custom domain\n\n### Parameters\n\n- `description: string`\n  What this domain models.\n\n- `domain_id: string`\n  Custom id, e.g. 'acme:support_tickets:1.0.0'.\n\n- `name: string`\n  Human-readable domain name.\n\n- `signals: { description: string; name: string; allowed_values?: string[]; frequency_hz?: number; required?: boolean; type?: 'enum' | 'text' | 'numeric' | 'date' | 'boolean' | 'multi_value_text'; weight?: number; }[]`\n  Per-domain signal definitions.\n\n- `catalog_config?: { enabled?: boolean; refresh_every_n?: number; }`\n  Catalog settings on a domain.\n  - `enabled?: boolean`\n    Whether to auto-accumulate signals on transform.\n  - `refresh_every_n?: number`\n    Run LLM clustering after this many buffered entries.\n\n- `routing_config?: { caesar4_source?: string; ce_gate_min_phi?: number; disabled_rules?: string[]; egr_lambda_ce?: number; enabled_rule_packs?: string[]; enhanced_initial_source?: string; holographic_floor?: boolean; threshold_overrides?: object; }`\n  Domain-scoped CAESAR-VIII routing overrides (stored on graph_domains).\n  - `caesar4_source?: string`\n    Which ranking is exposed as rankings['caesar4'] to CAESAR-VIII rules (c4_c7_diverge, etc.). Accepts 'v4a' (default — alias to family-routed v4a / v3a fallback), 'v3a' (force v3a only), or 'legacy' (SKIP the alias; keep the original Jaccard / trust-score selection at rankings['caesar4'] and stash a copy at rankings['_caesar4_legacy']). Use 'legacy' to A/B C-VIII rules against the original SciFact calibration semantics. Label-free in all modes.\n  - `ce_gate_min_phi?: number`\n    Minimum phi to allow caesar7/baseline_rerank to bypass holographic floor.\n  - `disabled_rules?: string[]`\n    Global SciFact routing rule names to skip for this domain (e.g. 'DANGER_LOW_RSG_LOW_PHI').\n  - `egr_lambda_ce?: number`\n    Stacked EGR entailment fusion weight (0–1). Lower for code domains.\n  - `enabled_rule_packs?: string[]`\n    Named domain rule packs to run after global rules (e.g. 'cosqa_caesar8_v2').\n  - `enhanced_initial_source?: string`\n    CAESAR-VIII initial source for the CE-on path. Domain defaults may pin 'caesar4_5_v4a' on code_search for public enhanced; public max overrides to 'caesar7' unless this field is set.\n  - `holographic_floor?: boolean`\n    When true, never return a ranking worse than max(v4a, baseline) unless CE gate (ce_gate_min_phi) passes.\n  - `threshold_overrides?: object`\n    Optional CaesarConfig field overrides keyed by threshold name (e.g. {'cmas_c4_trust_jaccard_threshold': 0.95}).\n\n- `signal_multipliers?: object`\n  Domain-level default signal weight multipliers. Applied automatically on every rerank/search request for this domain (unless the caller supplies their own signal_multipliers, which take priority). Keys are field names (e.g. 'key_claim') or Hz-strings (e.g. '70.0'). Values: 0.0 = disable band, 1.0 = unchanged, 2.0 = 2× boost.\n\n### Returns\n\n- `{ description: string; domain_id: string; name: string; signals: { description: string; name: string; allowed_values?: string[]; frequency_hz?: number; required?: boolean; type?: 'enum' | 'text' | 'numeric' | 'date' | 'boolean' | 'multi_value_text'; weight?: number; }[]; builtin?: boolean; catalog?: { domain_distribution?: object; entity_clusters?: catalog_entity_cluster[]; last_refreshed?: string; last_updated?: string; relationship_patterns?: catalog_relationship_pattern[]; signal_value_counts?: object; total_documents?: number; }; catalog_buffer?: { signals: object; timestamp: string; }[]; catalog_config?: { enabled?: boolean; refresh_every_n?: number; }; created_at?: string; owner_namespace_id?: string; owner_organization_id?: string; owner_user_id?: string; owner_workspace_id?: string; routing_config?: { caesar4_source?: string; ce_gate_min_phi?: number; disabled_rules?: string[]; egr_lambda_ce?: number; enabled_rule_packs?: string[]; enhanced_initial_source?: string; holographic_floor?: boolean; threshold_overrides?: object; }; signal_multipliers?: object; }`\n\n  - `description: string`\n  - `domain_id: string`\n  - `name: string`\n  - `signals: { description: string; name: string; allowed_values?: string[]; frequency_hz?: number; required?: boolean; type?: 'enum' | 'text' | 'numeric' | 'date' | 'boolean' | 'multi_value_text'; weight?: number; }[]`\n  - `builtin?: boolean`\n  - `catalog?: { domain_distribution?: object; entity_clusters?: { label: string; count?: number; members?: string[]; }[]; last_refreshed?: string; last_updated?: string; relationship_patterns?: { label: string; count?: number; members?: string[]; }[]; signal_value_counts?: object; total_documents?: number; }`\n  - `catalog_buffer?: { signals: object; timestamp: string; }[]`\n  - `catalog_config?: { enabled?: boolean; refresh_every_n?: number; }`\n  - `created_at?: string`\n  - `owner_namespace_id?: string`\n  - `owner_organization_id?: string`\n  - `owner_user_id?: string`\n  - `owner_workspace_id?: string`\n  - `routing_config?: { caesar4_source?: string; ce_gate_min_phi?: number; disabled_rules?: string[]; egr_lambda_ce?: number; enabled_rule_packs?: string[]; enhanced_initial_source?: string; holographic_floor?: boolean; threshold_overrides?: object; }`\n  - `signal_multipliers?: object`\n\n### Example\n\n```typescript\nimport Papr from '@papr/memory';\n\nconst client = new Papr();\n\nconst domain = await client.graph.domains.create({\n  description: 'description',\n  domain_id: 'domain_id',\n  name: 'name',\n  signals: [{ description: 'description', name: 'name' }],\n});\n\nconsole.log(domain);\n```",
    perLanguage: {
      typescript: {
        method: 'client.graph.domains.create',
        example:
  ...
  {
    name: 'retrieve',
    endpoint: '/v1/graph/domains/{domain_id}',
    httpMethod: 'get',
    summary: 'Get a single domain by id',
    description: 'Get a single domain by id',
    stainlessPath: '(resource) graph.domains > (method) retrieve',
    qualified: 'client.graph.domains.retrieve',
    params: ['domain_id: string;'],
    response:
      "{ description: string; domain_id: string; name: string; signals: { description: string; name: string; allowed_values?: string[]; frequency_hz?: number; required?: boolean; type?: 'enum' | 'text' | 'numeric' | 'date' | 'boolean' | 'multi_value_text'; weight?: number; }[]; builtin?: boolean; catalog?: { domain_distribution?: object; entity_clusters?: catalog_entity_cluster[]; last_refreshed?: string; last_updated?: string; relationship_patterns?: catalog_relationship_pattern[]; signal_value_counts?: object; total_documents?: number; }; catalog_buffer?: { signals: object; timestamp: string; }[]; catalog_config?: { enabled?: boolean; refresh_every_n?: number; }; created_at?: string; owner_namespace_id?: string; owner_organization_id?: string; owner_user_id?: string; owner_workspace_id?: string; routing_config?: { caesar4_source?: string; ce_gate_min_phi?: number; disabled_rules?: string[]; egr_lambda_ce?: number; enabled_rule_packs?: string[]; enhanced_initial_source?: string; holographic_floor?: boolean; threshold_overrides?: object; }; signal_multipliers?: object; }",
    markdown:
      "## retrieve\n\n`client.graph.domains.retrieve(domain_id: string): { description: string; domain_id: string; name: string; signals: signal_field[]; builtin?: boolean; catalog?: domain_catalog; catalog_buffer?: catalog_buffer_entry[]; catalog_config?: domain_catalog_config; created_at?: string; owner_namespace_id?: string; owner_organization_id?: string; owner_user_id?: string; owner_workspace_id?: string; routing_config?: graph_domain_routing_config; signal_multipliers?: object; }`\n\n**get** `/v1/graph/domains/{domain_id}`\n\nGet a single domain by id\n\n### Parameters\n\n- `domain_id: string`\n\n### Returns\n\n- `{ description: string; domain_id: string; name: string; signals: { description: string; name: string; allowed_values?: string[]; frequency_hz?: number; required?: boolean; type?: 'enum' | 'text' | 'numeric' | 'date' | 'boolean' | 'multi_value_text'; weight?: number; }[]; builtin?: boolean; catalog?: { domain_distribution?: object; entity_clusters?: catalog_entity_cluster[]; last_refreshed?: string; last_updated?: string; relationship_patterns?: catalog_relationship_pattern[]; signal_value_counts?: object; total_documents?: number; }; catalog_buffer?: { signals: object; timestamp: string; }[]; catalog_config?: { enabled?: boolean; refresh_every_n?: number; }; created_at?: string; owner_namespace_id?: string; owner_organization_id?: string; owner_user_id?: string; owner_workspace_id?: string; routing_config?: { caesar4_source?: string; ce_gate_min_phi?: number; disabled_rules?: string[]; egr_lambda_ce?: number; enabled_rule_packs?: string[]; enhanced_initial_source?: string; holographic_floor?: boolean; threshold_overrides?: object; }; signal_multipliers?: object; }`\n\n  - `description: string`\n  - `domain_id: string`\n  - `name: string`\n  - `signals: { description: string; name: string; allowed_values?: string[]; frequency_hz?: number; required?: boolean; type?: 'enum' | 'text' | 'numeric' | 'date' | 'boolean' | 'multi_value_text'; weight?: number; }[]`\n  - `builtin?: boolean`\n  - `catalog?: { domain_distribution?: object; entity_clusters?: { label: string; count?: number; members?: string[]; }[]; last_refreshed?: string; last_updated?: string; relationship_patterns?: { label: string; count?: number; members?: string[]; }[]; signal_value_counts?: object; total_documents?: number; }`\n  - `catalog_buffer?: { signals: object; timestamp: string; }[]`\n  - `catalog_config?: { enabled?: boolean; refresh_every_n?: number; }`\n  - `created_at?: string`\n  - `owner_namespace_id?: string`\n  - `owner_organization_id?: string`\n  - `owner_user_id?: string`\n  - `owner_workspace_id?: string`\n  - `routing_config?: { caesar4_source?: string; ce_gate_min_phi?: number; disabled_rules?: string[]; egr_lambda_ce?: number; enabled_rule_packs?: string[]; enhanced_initial_source?: string; holographic_floor?: boolean; threshold_overrides?: object; }`\n  - `signal_multipliers?: object`\n\n### Example\n\n```typescript\nimport Papr from '@papr/memory';\n\nconst client = new Papr();\n\nconst domain = await client.graph.domains.retrieve('domain_id');\n\nconsole.log(domain);\n```",
    perLanguage: {
      typescript: {
        method: 'client.graph.domains.retrieve',
        example:
          "import Papr from '@papr/memory';\n\nconst client = new Papr({\n  xAPIKey: process.env['PAPR_MEMORY_API_KEY'], // This is the default and can be omitted\n});\n\nconst domain = await client.graph.domains.retrieve('domain_id');\n\nconsole.log(domain.domain_id);",
      },
      python: {
  ...
  },
  {
    ...
    endpoint: '/v1/graph/domains/{domain_id}',
    httpMethod: 'put',
    summary: 'Update name, description, or signal_multipliers for a custom domain',
    description: 'Update name, description, or signal_multipliers for a custom domain',
    stainlessPath: '(resource) graph.domains > (method) update',
    qualified: 'client.graph.domains.update',
    params: [
      'domain_id: string;',
      'catalog_config?: { enabled?: boolean; refresh_every_n?: number; };',
      'description?: string;',
  ...
  },
  {
    ...
    stainlessPath: '(resource) graph.domains > (method) delete',
    qualified: 'client.graph.domains.delete',
    params: ['domain_id: string;'],
    response: '{ deleted: boolean; domain_id: string; }',
    markdown:
      "## delete\n\n`client.graph.domains.delete(domain_id: string): { deleted: boolean; domain_id: string; }`\n\n**delete** `/v1/graph/domains/{domain_id}`\n\nDelete a custom domain\n\n### Parameters\n\n- `domain_id: string`\n\n### Returns\n\n- `{ deleted: boolean; domain_id: string; }`\n\n  - `deleted: boolean`\n  - `domain_id: string`\n\n### Example\n\n```typescript\nimport Papr from '@papr/memory';\n\nconst client = new Papr();\n\nconst domain = await client.graph.domains.delete('domain_id');\n\nconsole.log(domain);\n```",
    perLanguage: {
      typescript: {
        method: 'client.graph.domains.delete',
        example:
          "import Papr from '@papr/memory';\n\nconst client = new Papr({\n  xAPIKey: process.env['PAPR_MEMORY_API_KEY'], // This is the default and can be omitted\n});\n\nconst domain = await client.graph.domains.delete('domain_id');\n\nconsole.log(domain.domain_id);",
      },
      python: {
  ...
  {
    name: 'retrieve',
    endpoint: '/v1/graph/domains/{domain_id}/catalog',
    httpMethod: 'get',
    summary: 'Get the curated signal catalog for a domain',
    description:
    ...
    stainlessPath: '(resource) graph.domains.catalog > (method) retrieve',
    qualified: 'client.graph.domains.catalog.retrieve',
    params: ['domain_id: string;'],
    response:
      '{ domain_distribution?: object; entity_clusters?: { label: string; count?: number; members?: string[]; }[]; last_refreshed?: string; last_updated?: string; relationship_patterns?: { label: string; count?: number; members?: string[]; }[]; signal_value_counts?: object; total_documents?: number; }',
    markdown:
      "## retrieve\n\n`client.graph.domains.catalog.retrieve(domain_id: string): { domain_distribution?: object; entity_clusters?: catalog_entity_cluster[]; last_refreshed?: string; last_updated?: string; relationship_patterns?: catalog_relationship_pattern[]; signal_value_counts?: object; total_documents?: number; }`\n\n**get** `/v1/graph/domains/{domain_id}/catalog`\n\nReturn the LLM-curated catalog showing what signal values exist in this domain.\n\nThe catalog is built incrementally from transform calls. It contains:\n- entity_clusters: semantically-grouped entity values\n- relationship_patterns: clustered relationship types\n- signal_value_counts: raw per-band value frequencies\n- domain_distribution: per-band document counts\n- total_documents: total transforms processed\n\n### Parameters\n\n- `domain_id: string`\n\n### Returns\n\n- `{ domain_distribution?: object; entity_clusters?: { label: string; count?: number; members?: string[]; }[]; last_refreshed?: string; last_updated?: string; relationship_patterns?: { label: string; count?: number; members?: string[]; }[]; signal_value_counts?: object; total_documents?: number; }`\n  Curated summary of what's in a domain's frequency space.\n\n  - `domain_distribution?: object`\n  - `entity_clusters?: { label: string; count?: number; members?: string[]; }[]`\n  - `last_refreshed?: string`\n  - `last_updated?: string`\n  - `relationship_patterns?: { label: string; count?: number; members?: string[]; }[]`\n  - `signal_value_counts?: object`\n  - `total_documents?: number`\n\n### Example\n\n```typescript\nimport Papr from '@papr/memory';\n\nconst client = new Papr();\n\nconst domainCatalog = await client.graph.domains.catalog.retrieve('domain_id');\n\nconsole.log(domainCatalog);\n```",
    perLanguage: {
      typescript: {
        method: 'client.graph.domains.catalog.retrieve',
        example:
          "import Papr from '@papr/memory';\n\nconst client = new Papr({\n  xAPIKey: process.env['PAPR_MEMORY_API_KEY'], // This is the default and can be omitted\n});\n\nconst domainCatalog = await client.graph.domains.catalog.retrieve('domain_id');\n\nconsole.log(domainCatalog.domain_distribution);",
      },
      python: {
        method: 'graph.domains.catalog.retrieve',
        example:
          'import os\nfrom papr_memory import Papr\n\nclient = Papr(\n    x_api_key=os.environ.get("PAPR_MEMORY_API_KEY"),  # This is the default and can be omitted\n)\ndomain_catalog = client.graph.domains.catalog.retrieve(\n    "domain_id",\n)\nprint(domain_catalog.domain_distribution)',
      },
      http: {
        example:
          'curl https://memory.papr.ai/v1/graph/domains/$DOMAIN_ID/catalog \\\n    -H "X-API-Key: $PAPR_MEMORY_API_KEY"',
      },
    },
  },
  {
    name: 'refresh',
    endpoint: '/v1/graph/domains/{domain_id}/catalog/refresh',
    httpMethod: 'post',
    summary: 'Trigger LLM clustering on buffered signal values',
    description:
      'Process any buffered signal values through LLM clustering.\n\nThis merges raw signal values from recent transform calls into semantic\nclusters. Normally happens automatically every N transforms, but this\nendpoint lets you trigger it on-demand.',
    stainlessPath: '(resource) graph.domains.catalog > (method) refresh',
    qualified: 'client.graph.domains.catalog.refresh',
    params: ['domain_id: string;'],
    response:
      '{ domain_distribution?: object; entity_clusters?: { label: string; count?: number; members?: string[]; }[]; last_refreshed?: string; last_updated?: string; relationship_patterns?: { label: string; count?: number; members?: string[]; }[]; signal_value_counts?: object; total_documents?: number; }',
    markdown:
      "## refresh\n\n`client.graph.domains.catalog.refresh(domain_id: string): { domain_distribution?: object; entity_clusters?: catalog_entity_cluster[]; last_refreshed?: string; last_updated?: string; relationship_patterns?: catalog_relationship_pattern[]; signal_value_counts?: object; total_documents?: number; }`\n\n**post** `/v1/graph/domains/{domain_id}/catalog/refresh`\n\nProcess any buffered signal values through LLM clustering.\n\nThis merges raw signal values from recent transform calls into semantic\nclusters. Normally happens automatically every N transforms, but this\nendpoint lets you trigger it on-demand.\n\n### Parameters\n\n- `domain_id: string`\n\n### Returns\n\n- `{ domain_distribution?: object; entity_clusters?: { label: string; count?: number; members?: string[]; }[]; last_refreshed?: string; last_updated?: string; relationship_patterns?: { label: string; count?: number; members?: string[]; }[]; signal_value_counts?: object; total_documents?: number; }`\n  Curated summary of what's in a domain's frequency space.\n\n  - `domain_distribution?: object`\n  - `entity_clusters?: { label: string; count?: number; members?: string[]; }[]`\n  - `last_refreshed?: string`\n  - `last_updated?: string`\n  - `relationship_patterns?: { label: string; count?: number; members?: string[]; }[]`\n  - `signal_value_counts?: object`\n  - `total_documents?: number`\n\n### Example\n\n```typescript\nimport Papr from '@papr/memory';\n\nconst client = new Papr();\n\nconst domainCatalog = await client.graph.domains.catalog.refresh('domain_id');\n\nconsole.log(domainCatalog);\n```",
    perLanguage: {
      typescript: {
        method: 'client.graph.domains.catalog.refresh',
        example:
          "import Papr from '@papr/memory';\n\nconst client = new Papr({\n  xAPIKey: process.env['PAPR_MEMORY_API_KEY'], // This is the default and can be omitted\n});\n\nconst domainCatalog = await client.graph.domains.catalog.refresh('domain_id');\n\nconsole.log(domainCatalog.domain_distribution);",
      },
      python: {
        method: 'graph.domains.catalog.refresh',
        example:
          'import os\nfrom papr_memory import Papr\n\nclient = Papr(\n    x_api_key=os.environ.get("PAPR_MEMORY_API_KEY"),  # This is the default and can be omitted\n)\ndomain_catalog = client.graph.domains.catalog.refresh(\n    "domain_id",\n)\nprint(domain_catalog.domain_distribution)',
      },
      http: {
        example:
          'curl https://memory.papr.ai/v1/graph/domains/$DOMAIN_ID/catalog/refresh \\\n    -X POST \\\n    -H "X-API-Key: $PAPR_MEMORY_API_KEY"',
      },
    },
  },
];
