...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: [
      ...
      'organization_id?: string;',
      "policy?: { consent?: 'explicit' | 'implicit' | 'terms' | 'none'; graph?: { edge_constraints?: object[]; link_to?: string | string[] | object; mode?: 'none' | 'auto' | 'manual'; node_constraints?: object[]; nodes?: object[]; relationships?: object[]; schema_id?: string; }; risk?: 'none' | 'sensitive' | 'flagged'; vector?: { domain_id?: string; mode?: 'fast' | 'enhanced' | 'max'; return_debug?: boolean; return_signal_scores?: boolean; signal_multipliers?: object; signal_thresholds?: object; }; };",
      'rank_results?: boolean;',
      "reranking_config?: { domain_id?: string; reranking_enabled?: boolean; reranking_model?: string; reranking_provider?: 'none' | 'cohere' | 'openai' | 'papr_enhanced' | 'papr_max'; return_debug?: boolean; return_signal_scores?: boolean; signal_multipliers?: object; signal_thresholds?: object; };",
      'schema_id?: string;',
  ...
  },
  {
    ...
    params: [
      ...
      'namespace_id?: string;',
      'policy?: string;',
      "preferred_provider?: 'gemini' | 'tensorlake' | 'reducto' | 'paddleocr' | 'auto';",
  ...
  },
  {
    ...
    params: ['upload_id: string;', 'timeline?: boolean;'],
    response:
      "{ status: string; upload_id: string; current_page?: number; error?: string; message?: string; page_id?: string; progress?: number; timeline?: { steps?: { id: string; description: string; label: string; status: 'pending' | 'in_progress' | 'completed' | 'failed' | 'skipped'; completed_at?: string; duration_ms?: number; error?: string; page_id?: string; progress?: number; started_at?: string; total_pages?: number; }[]; total_elapsed_ms?: number; updated_at?: string; }; timestamp?: string; total_pages?: number; workflow_type?: string; }",
    markdown:
      "## get_status\n\n`client.document.getStatus(upload_id: string, timeline?: boolean): { status: string; upload_id: string; current_page?: number; error?: string; message?: string; page_id?: string; progress?: number; timeline?: object; timestamp?: string; total_pages?: number; workflow_type?: string; }`\n\n**get** `/v1/document/status/{upload_id}`\n\nGet processing status for an uploaded document.\n\nPass ``?timeline=true`` to include step-by-step processing detail without\nchanging the default flat status fields.\n\n### Parameters\n\n- `upload_id: string`\n\n- `timeline?: boolean`\n  When true, include a `timeline` object with ordered processing steps, per-step status, and timing. Default response shape is unchanged.\n\n### Returns\n\n- `{ status: string; upload_id: string; current_page?: number; error?: string; message?: string; page_id?: string; progress?: number; timeline?: { steps?: { id: string; description: string; label: string; status: 'pending' | 'in_progress' | 'completed' | 'failed' | 'skipped'; completed_at?: string; duration_ms?: number; error?: string; page_id?: string; progress?: number; started_at?: string; total_pages?: number; }[]; total_elapsed_ms?: number; updated_at?: string; }; timestamp?: string; total_pages?: number; workflow_type?: string; }`\n  GET /v1/document/status/{upload_id} response. Pass ?timeline=true to include timeline.\n\n  - `status: string`\n  - `upload_id: string`\n  - `current_page?: number`\n  - `error?: string`\n  - `message?: string`\n  - `page_id?: string`\n  - `progress?: number`\n  - `timeline?: { steps?: { id: string; description: string; label: string; status: 'pending' | 'in_progress' | 'completed' | 'failed' | 'skipped'; completed_at?: string; duration_ms?: number; error?: string; page_id?: string; progress?: number; started_at?: string; total_pages?: number; }[]; total_elapsed_ms?: number; updated_at?: string; }`\n  - `timestamp?: string`\n  - `total_pages?: number`\n  - `workflow_type?: string`\n\n### Example\n\n```typescript\nimport Papr from '@papr/memory';\n\nconst client = new Papr();\n\nconst response = await client.document.getStatus('upload_id');\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ messages: { content: string | { type: string; text?: string; }[]; createdAt: string; objectId: string; role: 'user' | 'assistant'; sessionId: string; processing_status?: string; }[]; sessionId: string; total_count: number; context_for_llm?: string; summaries?: { current_state?: string; files_accessed?: object; key_decisions?: string[]; last_updated?: string; long_term?: string; medium_term?: string; next_steps?: string[]; project_context?: object; session_intent?: string; short_term?: string; technical_details?: string[]; topics?: string[]; }; }",
    markdown:
      "## retrieve_history\n\n`client.messages.sessions.retrieveHistory(session_id: string, limit?: number, skip?: number): { messages: object[]; sessionId: string; total_count: number; context_for_llm?: string; summaries?: conversation_summary_response; }`\n\n**get** `/v1/messages/sessions/{session_id}`\n\nRetrieve message history for a specific conversation session.\n    \n    **Authentication Required**: Bearer token, API key, or session token\n    \n    **Pagination**:\n    - Use `limit` and `skip` parameters for pagination\n    - Messages are returned in **reverse chronological order** (newest first)\n    - `total_count` indicates total messages in the session\n    \n    **Summaries** (if available):\n    - Returns hierarchical conversation summaries (short/medium/long-term)\n    - Includes `context_for_llm` field with pre-compressed context\n    - Summaries are automatically generated every 15 messages\n    - Use `/sessions/{session_id}/compress` endpoint to retrieve on-demand\n    \n    **Access Control**:\n    - Only returns messages for the authenticated user\n    - Workspace scoping is applied if available\n\n### Parameters\n\n- `session_id: string`\n\n- `limit?: number`\n  Maximum number of messages to return\n\n- `skip?: number`\n  Number of messages to skip for pagination\n\n### Returns\n\n- `{ messages: { content: string | { type: string; text?: string; }[]; createdAt: string; objectId: string; role: 'user' | 'assistant'; sessionId: string; processing_status?: string; }[]; sessionId: string; total_count: number; context_for_llm?: string; summaries?: { current_state?: string; files_accessed?: object; key_decisions?: string[]; last_updated?: string; long_term?: string; medium_term?: string; next_steps?: string[]; project_context?: object; session_intent?: string; short_term?: string; technical_details?: string[]; topics?: string[]; }; }`\n  Response model for retrieving message history\n\n  - `messages: { content: string | { type: string; text?: string; }[]; createdAt: string; objectId: string; role: 'user' | 'assistant'; sessionId: string; processing_status?: string; }[]`\n  - `sessionId: string`\n  - `total_count: number`\n  - `context_for_llm?: string`\n  - `summaries?: { current_state?: string; files_accessed?: object; key_decisions?: string[]; last_updated?: string; long_term?: string; medium_term?: string; next_steps?: string[]; project_context?: object; session_intent?: string; short_term?: string; technical_details?: string[]; topics?: string[]; }`\n\n### Example\n\n```typescript\nimport Papr from '@papr/memory';\n\nconst client = new Papr();\n\nconst response = await client.messages.sessions.retrieveHistory('session_id');\n\nconsole.log(response);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: ['session_id: string;'],
    response:
      '{ ai_agent_note: string; from_cache: boolean; session_id: string; summaries: { current_state?: string; files_accessed?: object; key_decisions?: string[]; last_updated?: string; long_term?: string; medium_term?: string; next_steps?: string[]; project_context?: object; session_intent?: string; short_term?: string; technical_details?: string[]; topics?: string[]; }; message_count?: number; }',
    markdown:
  ...
  },
  {
    ...
    response:
      '{ domains: { description: string; domain_id: string; name: string; signals: object[]; builtin?: boolean; catalog?: { domain_distribution?: object; entity_clusters?: catalog_entity_cluster[]; last_refreshed?: string; last_updated?: string; relationship_patterns?: catalog_relationship_pattern[]; signal_value_counts?: object; total_documents?: number; }; catalog_buffer?: object[]; catalog_config?: { enabled?: boolean; refresh_every_n?: number; }; created_at?: string; owner_namespace_id?: string; owner_organization_id?: string; owner_user_id?: string; owner_workspace_id?: string; routing_config?: object; signal_multipliers?: object; }[]; }',
    markdown:
  ...
  },
  {
    ...
    response:
      "{ description: string; domain_id: string; name: string; signals: { description: string; name: string; allowed_values?: string[]; frequency_hz?: number; required?: boolean; type?: 'enum' | 'text' | 'numeric' | 'date' | 'boolean' | 'multi_value_text'; weight?: number; }[]; builtin?: boolean; catalog?: { domain_distribution?: object; entity_clusters?: object[]; last_refreshed?: string; last_updated?: string; relationship_patterns?: object[]; signal_value_counts?: object; total_documents?: number; }; catalog_buffer?: { signals: object; timestamp: string; }[]; catalog_config?: { enabled?: boolean; refresh_every_n?: number; }; created_at?: string; owner_namespace_id?: string; owner_organization_id?: string; owner_user_id?: string; owner_workspace_id?: string; routing_config?: { caesar4_source?: string; ce_gate_min_phi?: number; disabled_rules?: string[]; egr_lambda_ce?: number; enabled_rule_packs?: string[]; enhanced_initial_source?: string; holographic_floor?: boolean; threshold_overrides?: object; }; signal_multipliers?: object; }",
    markdown:
      "## retrieve\n\n`client.graph.domains.retrieve(domain_id: string): { description: string; domain_id: string; name: string; signals: signal_field[]; builtin?: boolean; catalog?: object; catalog_buffer?: catalog_buffer_entry[]; catalog_config?: object; created_at?: string; owner_namespace_id?: string; owner_organization_id?: string; owner_user_id?: string; owner_workspace_id?: string; routing_config?: graph_domain_routing_config; signal_multipliers?: object; }`\n\n**get** `/v1/graph/domains/{domain_id}`\n\nGet a single domain by id\n\n### Parameters\n\n- `domain_id: string`\n\n### Returns\n\n- `{ description: string; domain_id: string; name: string; signals: { description: string; name: string; allowed_values?: string[]; frequency_hz?: number; required?: boolean; type?: 'enum' | 'text' | 'numeric' | 'date' | 'boolean' | 'multi_value_text'; weight?: number; }[]; builtin?: boolean; catalog?: { domain_distribution?: object; entity_clusters?: object[]; last_refreshed?: string; last_updated?: string; relationship_patterns?: object[]; signal_value_counts?: object; total_documents?: number; }; catalog_buffer?: { signals: object; timestamp: string; }[]; catalog_config?: { enabled?: boolean; refresh_every_n?: number; }; created_at?: string; owner_namespace_id?: string; owner_organization_id?: string; owner_user_id?: string; owner_workspace_id?: string; routing_config?: { caesar4_source?: string; ce_gate_min_phi?: number; disabled_rules?: string[]; egr_lambda_ce?: number; enabled_rule_packs?: string[]; enhanced_initial_source?: string; holographic_floor?: boolean; threshold_overrides?: object; }; signal_multipliers?: object; }`\n\n  - `description: string`\n  - `domain_id: string`\n  - `name: string`\n  - `signals: { description: string; name: string; allowed_values?: string[]; frequency_hz?: number; required?: boolean; type?: 'enum' | 'text' | 'numeric' | 'date' | 'boolean' | 'multi_value_text'; weight?: number; }[]`\n  - `builtin?: boolean`\n  - `catalog?: { domain_distribution?: object; entity_clusters?: { label: string; count?: number; members?: string[]; }[]; last_refreshed?: string; last_updated?: string; relationship_patterns?: { label: string; count?: number; members?: string[]; }[]; signal_value_counts?: object; total_documents?: number; }`\n  - `catalog_buffer?: { signals: object; timestamp: string; }[]`\n  - `catalog_config?: { enabled?: boolean; refresh_every_n?: number; }`\n  - `created_at?: string`\n  - `owner_namespace_id?: string`\n  - `owner_organization_id?: string`\n  - `owner_user_id?: string`\n  - `owner_workspace_id?: string`\n  - `routing_config?: { caesar4_source?: string; ce_gate_min_phi?: number; disabled_rules?: string[]; egr_lambda_ce?: number; enabled_rule_packs?: string[]; enhanced_initial_source?: string; holographic_floor?: boolean; threshold_overrides?: object; }`\n  - `signal_multipliers?: object`\n\n### Example\n\n```typescript\nimport Papr from '@papr/memory';\n\nconst client = new Papr();\n\nconst domain = await client.graph.domains.retrieve('domain_id');\n\nconsole.log(domain);\n```",
    perLanguage: {
      typescript: {
